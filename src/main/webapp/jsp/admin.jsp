...
<body>
	...
	<section>
		<div class="container1" id="ischooseFile01">
			...
			<button type="button" id="upfilebutton_id" class="btn btn-primary"
				...
				data-target=".bs-modal-lg">添加科目或批次</button>
			<div class="modal fade bs-modal-lg" id="addmodel" tabindex="-1"
	...
	<script>
		...
		function changeState(oid, ostate) {
			...
			$.get("${basePath }changeKeyByOID?oid=" + oid
					+ "&key=ostate&value=" + value, function() {
				$("#loadsubject").load("${basePath}subjectui");
			});
		}
		...
		$(function() {
			...
			$("#subject_ID").change(
					function() {
						...
						$.get("${basePath }getOnameBysubjectOfAll?subject="

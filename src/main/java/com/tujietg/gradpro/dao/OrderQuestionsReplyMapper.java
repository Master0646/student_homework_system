...
public interface OrderQuestionsReplyMapper {
	...
	int updateByExampleSelective(@Param("record") OrderQuestionsReply record,
			@Param("example") OrderQuestionsReplyExample example);

	int updateByExample(@Param("record") OrderQuestionsReply record,
			@Param("example") OrderQuestionsReplyExample example);
